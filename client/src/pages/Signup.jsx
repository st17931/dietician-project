    ...
    <section className="relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 top-0 z-20 sm:p-10">
        <div className="flex flex-col items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:justify-center lg:px-8 lg:py-16 xl:justify-center">
          <Slide>
            <div className=" mb-5 min-w-fit rounded-lg bg-slate-200/50 px-10 py-10 backdrop-blur-sm">
              <h2 className="text-center text-2xl font-bold leading-tight text-black">
                Create a new account
              </h2>
              <form onSubmit={handleSubmit} className="mt-8 sm:w-[500px]">
      ...
      <div className="relative h-svh translate-x-0 overflow-hidden">
        ...
        <img
          src="https://images.unsplash.com/photo-1591311630200-ffa9120a540f?q=80&w=1710&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA"
          alt=""
