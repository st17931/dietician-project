  ...
  return (
    <div className="mx-2 mb-10 flex max-w-sm items-center divide-x-2 divide-slate-200 rounded bg-black  p-2 shadow-lg dark:divide-slate-800 dark:bg-slate-100">
      ...
      <div className="px-4">
        ...
        <p className="text-gray-400 dark:text-gray-800">UI/UX Designer</p>
        <div className="mt-4 flex items-center">
          ...
          <p className="text-yellow-500 dark:text-amber-500">4.5</p>
        </div>
        <p className="mt-2 text-gray-400 dark:text-gray-800">
