...
function Pricing() {
  return (
    <section className="dark:bg-slate-900">
      ...
      <p className="mt-4 text-center text-lg font-semibold opacity-60 dark:text-slate-100">
      ...
      <div className="mx-auto flex w-full flex-wrap items-center gap-y-2 bg-slate-100 p-10 py-10 dark:bg-slate-900 ">
        ...
        <div className="w-full rounded border bg-black p-5 text-white hover:shadow-lg dark:bg-slate-100 dark:text-slate-900 md:w-1/2 lg:w-1/3">
          <div className="flex">
            <h5 className="text-lg font-bold opacity-60">Gold</h5>
          ...
          <button
            type="button"
            className="my-3 w-[100%] rounded-full bg-slate-200 p-2 font-medium text-black dark:bg-slate-900 dark:text-slate-200"
          >
            Get Started
          </button>
